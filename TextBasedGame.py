...
def get_player_action():
    ...
    while command == -1 or (
        ...
        # Check if valid command of help was given, but an invalid second value was entered.
        if command == Command.HELP:
            # Breaks out of the loop regardless of second value if the player wants help.
            break
        # If we get here, then we know the command isn't help.
...
def main():
    ...
    while not quit_game:
        ...
        if player_command == Command.HELP:
